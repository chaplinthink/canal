...
import com.alibaba.otter.canal.client.adapter.support.ConvertUtil;
...
public class StarrocksTemplate {
    ...
    public void sink(StarRocksBufferData bufferData) {
        ...
        StarRocksSinkOptions op = getStarRocksSinkOptions(srTable);
    ...
    private StarRocksSinkOptions getStarRocksSinkOptions(String srTable) {
